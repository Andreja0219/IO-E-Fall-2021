...
Objective: 
- Use the button to start/stop a song.
- Use the sound input to grow the circle.
- Use the light input to change the opacity of the circle.
...
function draw() {
  ...
  ellipseMode(RADIUS);
  circleColour = color(100,50,100);
  circleColour.setAlpha(128 + 128 * diameter2);
  fill(circleColour);
